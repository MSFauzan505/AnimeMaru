                ...
                {onGoing.map((anime, index) => (
                    <SwiperSlide key={anime.mal_id || index}>
                        ...
                        >
                            ...
                            />
                            <div className='absolute bottom-5 left-5 flex gap-1 flex-wrap'>
                            ...
                            <button className='absolute top-0 right-5 bg-red-400 text-white w-10 h-10  opacity-100 sm:opacity-0 group-hover:opacity-100 hover:bg-red-500 transition-all duration-300 ease-in-out text-2xl'>
                            +
                            </button>
                        </a>
